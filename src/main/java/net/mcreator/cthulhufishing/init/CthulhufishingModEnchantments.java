...
import net.mcreator.cthulhufishing.enchantment.FrozenCatcherEnchantmentEnchantment;
...
public class CthulhufishingModEnchantments {
	...
	public static final RegistryObject<Enchantment> FROZEN_CATCHER_ENCHANTMENT = REGISTRY.register("frozen_catcher_enchantment", () -> new FrozenCatcherEnchantmentEnchantment());
}
