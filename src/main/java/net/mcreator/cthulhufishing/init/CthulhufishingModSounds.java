...
public class CthulhufishingModSounds {
	...
	public static final RegistryObject<SoundEvent> FROZEN_CRAB_AOE = REGISTRY.register("frozen_crab_aoe", () -> new SoundEvent(new ResourceLocation("cthulhufishing", "frozen_crab_aoe")));
}
