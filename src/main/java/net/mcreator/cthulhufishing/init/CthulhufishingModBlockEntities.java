...
public class CthulhufishingModBlockEntities {
	...
	public static final RegistryObject<BlockEntityType<RelicAltarTileEntity>> RELIC_ALTAR = REGISTRY.register("relic_altar", () -> BlockEntityType.Builder.of(RelicAltarTileEntity::new, CthulhufishingModBlocks.RELIC_ALTAR.get()).build(null));
