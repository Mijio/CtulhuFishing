...
import net.mcreator.cthulhufishing.block.RelicAltarBlock;
...
public class CthulhufishingModBlocks {
	...
	public static final RegistryObject<Block> RELIC_ALTAR = REGISTRY.register("relic_altar", () -> new RelicAltarBlock());
}
