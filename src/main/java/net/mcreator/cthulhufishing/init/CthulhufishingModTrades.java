...
public class CthulhufishingModTrades {
	...
	public static void registerTrades(VillagerTradesEvent event) {
		if (event.getType() == CthulhufishingModVillagerProfessions.VOID_MERCHANT.get()) {
			...
			event.getTrades().get(5).add(new BasicItemListing(new ItemStack(Items.EMERALD, 32), new ItemStack(CthulhufishingModItems.REAGENT.get(), 14), new ItemStack(CthulhufishingModItems.CRIMSON_FINGER.get()), 10, 10, 0.05f));
			event.getTrades().get(5).add(new BasicItemListing(new ItemStack(Items.EMERALD, 32), new ItemStack(CthulhufishingModItems.REAGENT.get(), 14), new ItemStack(CthulhufishingModItems.REVELATION_FABRIC.get()), 10, 10, 0.05f));
			...
			event.getTrades().get(1).add(new BasicItemListing(new ItemStack(Items.EMERALD, 28), new ItemStack(CthulhufishingModItems.REAGENT.get(), 20), new ItemStack(CthulhufishingModItems.SWORD_OF_REVELATION.get()), 10, 15, 0.05f));
		}
	}
}
