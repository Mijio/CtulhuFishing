...
public class CthulhufishingModTrades {
	...
	public static void registerTrades(VillagerTradesEvent event) {
		if (event.getType() == CthulhufishingModVillagerProfessions.VOID_MERCHANT.get()) {
			...
			event.getTrades().get(1).add(new BasicItemListing(new ItemStack(CthulhufishingModItems.THIRD_EYE_R.get()), new ItemStack(Blocks.STONE), new ItemStack(CthulhufishingModItems.FADED_RUNIC_TABLET.get()), 1, 15, 0.05f));
			...
			event.getTrades().get(3).add(new BasicItemListing(new ItemStack(Items.EMERALD, 26), new ItemStack(CthulhufishingModItems.REAGENT.get(), 14), new ItemStack(CthulhufishingModItems.MASK_OF_REVELATION_R_HELMET.get()), 1, 20, 0.05f));
			event.getTrades().get(3).add(new BasicItemListing(new ItemStack(Items.EMERALD, 26), new ItemStack(CthulhufishingModItems.REAGENT.get(), 16), new ItemStack(CthulhufishingModItems.HOOD_OF_THE_DEEP_VOID_R_HELMET.get()), 1, 20, 0.05f));
