...
public class CthulhufishingModAttributes {
	...
	public static final RegistryObject<Attribute> SUMMONDAMAGE = ATTRIBUTES.register("summon_damage", () -> (new RangedAttribute("attribute." + CthulhufishingMod.MODID + ".summon_damage", 1, 0, 100)).setSyncable(true));
