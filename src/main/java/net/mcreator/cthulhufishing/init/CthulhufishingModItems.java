...
public class CthulhufishingModItems {
	...
	public static final RegistryObject<Item> CTHULHU_ADEPT_SPAWN_EGG = REGISTRY.register("cthulhu_adept_spawn_egg", () -> new ForgeSpawnEggItem(CthulhufishingModEntities.CTHULHU_ADEPT, -1, -1, new Item.Properties()));
