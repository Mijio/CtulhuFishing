	...
	public static void execute(LevelAccessor world, double x, double y, double z) {
			...
			if (y >= world.getHeight(Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (int) x, (int) z)) {
				if (!world.isClientSide()) {
					...
					if (_blockEntity != null)
						_blockEntity.getPersistentData().putDouble("night", (new Object() {
		...
		if (new Object() {
			...
			if (world instanceof ServerLevel _level) {
				Entity entityToSpawn = CthulhufishingModEntities.DELETED_MOD_ELEMENT.get().spawn(_level, BlockPos.containing(x + 1 + Math.random(), y, z - (1 + Math.random())), MobSpawnType.MOB_SUMMONED);
		...
		if (new Object() {
			...
			world.setBlock(BlockPos.containing(x, y, z), CthulhufishingModItems.DELETED_MOD_ELEMENT.get().defaultBlockState(), 3);
		}
	}
}
