...
public class AncientBlessingEffectExpiresProcedure {
	public static void execute(Entity entity) {
		...
		((LivingEntity) entity).getAttribute(net.minecraft.world.entity.ai.attributes.Attributes.ATTACK_DAMAGE).removeModifier(UUID.fromString("f4991cc1-a369-43e3-8fae-b0b5495e9d1d"));
	}
}
