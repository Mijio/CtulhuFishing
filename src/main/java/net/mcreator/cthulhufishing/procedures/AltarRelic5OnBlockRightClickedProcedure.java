...
public class AltarRelic5OnBlockRightClickedProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if ((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == CthulhufishingModItems.REAGENT.get()) {
			...
			world.setBlock(BlockPos.containing(x, y, z), CthulhufishingModBlocks.ALTAR_RELIC_6.get().defaultBlockState(), 3);
		}
	}
}
