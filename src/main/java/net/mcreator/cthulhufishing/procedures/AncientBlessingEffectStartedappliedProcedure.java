...
public class AncientBlessingEffectStartedappliedProcedure {
	public static void execute(Entity entity) {
		...
		if (!(((LivingEntity) entity).getAttribute(net.minecraft.world.entity.ai.attributes.Attributes.MAX_HEALTH)
				.hasModifier((new AttributeModifier(UUID.fromString("f4991cc1-a369-43e3-8fae-b0b5495e9d1d"), "multiplyer", 0.5, AttributeModifier.Operation.MULTIPLY_BASE)))))
			((LivingEntity) entity).getAttribute(net.minecraft.world.entity.ai.attributes.Attributes.MAX_HEALTH)
					.addPermanentModifier((new AttributeModifier(UUID.fromString("f4991cc1-a369-43e3-8fae-b0b5495e9d1d"), "multiplyer", 0.5, AttributeModifier.Operation.MULTIPLY_BASE)));
