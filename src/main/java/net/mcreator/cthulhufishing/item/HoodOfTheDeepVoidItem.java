...
public abstract class HoodOfTheDeepVoidItem extends ArmorItem {
	...
	public static class Helmet extends HoodOfTheDeepVoidItem {
			...
			consumer.accept(new IClientItemExtensions() {
				...
				public HumanoidModel getHumanoidArmorModel(LivingEntity living, ItemStack stack, EquipmentSlot slot, HumanoidModel defaultModel) {
					HumanoidModel armorModel = new HumanoidModel(new ModelPart(Collections.emptyList(),
							Map.of("head", new ModelHoodOfTheWhispersOfTheDeep(Minecraft.getInstance().getEntityModels().bakeLayer(ModelHoodOfTheWhispersOfTheDeep.LAYER_LOCATION)).bone, "hat",
		...
		public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
			...
			list.add(Component.literal("by expending the power of your revelation"));
			list.add(Component.literal("your attacks return part of the creature's damage"));
		}
