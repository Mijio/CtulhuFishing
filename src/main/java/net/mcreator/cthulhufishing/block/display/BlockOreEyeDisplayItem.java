...
import net.mcreator.cthulhufishing.block.renderer.BlockOreEyeDisplayItemRenderer;

import java.util.function.Consumer;

public class BlockOreEyeDisplayItem extends BlockItem implements GeoItem {
