...
import net.mcreator.cthulhufishing.block.renderer.AltarRelic5DisplayItemRenderer;

import java.util.function.Consumer;

public class AltarRelic5DisplayItem extends BlockItem implements GeoItem {
