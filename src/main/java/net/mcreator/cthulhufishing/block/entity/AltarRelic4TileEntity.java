...
public class AltarRelic4TileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<AltarRelic4TileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<AltarRelic4TileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
