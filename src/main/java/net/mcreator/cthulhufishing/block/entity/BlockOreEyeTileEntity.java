...
public class BlockOreEyeTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<BlockOreEyeTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<BlockOreEyeTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
