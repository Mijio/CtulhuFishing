...
public class AltarRelicTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<AltarRelicTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<AltarRelicTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
