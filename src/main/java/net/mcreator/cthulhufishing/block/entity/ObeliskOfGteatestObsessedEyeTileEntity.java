...
public class ObeliskOfGteatestObsessedEyeTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(9, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public ObeliskOfGteatestObsessedEyeTileEntity(BlockPos pos, BlockState state) {
		super(CthulhufishingModBlockEntities.OBELISK_OF_GTEATEST_OBSESSED_EYE.get(), pos, state);
	}
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<ObeliskOfGteatestObsessedEyeTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<ObeliskOfGteatestObsessedEyeTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("obelisk_of_gteatest_obsessed_eye");
	}
