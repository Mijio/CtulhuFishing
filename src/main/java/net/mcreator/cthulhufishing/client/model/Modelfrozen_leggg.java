...
public class Modelfrozen_leggg<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("cthulhufishing", "modelfrozen_leggg"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition RightLeg = partdefinition.addOrReplaceChild("RightLeg",
				CubeListBuilder.create().texOffs(0, 16).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(0, 32).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.25F)).texOffs(9, 21)
						...
						.addBox(-2.1F, 2.0F, -2.25F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(41, 17).addBox(-2.1F, 11.0F, -2.25F, 4.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(41, 17)
						.addBox(-2.1F, 11.0F, 1.25F, 4.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(39, 21).addBox(-2.1F, 10.0F, 1.25F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(39, 26)
		...
		PartDefinition cube_r1 = RightLeg.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(19, 26).addBox(0.1F, -5.6F, 3.25F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(19, 26).addBox(-1.6F, -7.7F, 3.25F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 26)
						...
						.addBox(0.0F, -2.0F, 3.25F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(41, 17).addBox(-2.0F, -1.0F, 3.25F, 4.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(19, 17)
		...
		PartDefinition LeftLeg = partdefinition.addOrReplaceChild("LeftLeg",
				CubeListBuilder.create().texOffs(16, 48).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(0, 48).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.25F)).texOffs(0, 21)
						...
						.addBox(0.7F, 0.4F, -2.45F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(41, 17).addBox(-1.9F, 11.0F, -2.25F, 4.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(41, 17)
						.addBox(-1.9F, 11.0F, 1.25F, 4.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(39, 21).addBox(0.1F, 10.0F, 1.25F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(39, 26)
		...
		PartDefinition cube_r2 = LeftLeg.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(39, 26).addBox(1.0F, -3.0F, -4.25F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(39, 26).addBox(-2.0F, -8.0F, -4.25F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(39, 26)
						...
						.addBox(0.0F, -2.0F, -4.25F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(41, 17).addBox(-2.0F, -1.0F, -4.25F, 4.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(30, 17)
						.addBox(-2.0F, -12.0F, -4.25F, 4.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-1.9F, 12.0F, 0.0F, 0.0F, -1.5708F, 0.0F));
		PartDefinition Body = partdefinition.addOrReplaceChild("Body",
				CubeListBuilder.create().texOffs(39, 21).addBox(-1.0F, -11.6F, -2.25F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 17).addBox(-4.0F, -12.0F, 1.25F, 8.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
