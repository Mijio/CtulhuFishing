...
public class Modelfrozen_leggings<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("cthulhufishing", "modelfrozen_leggings"), "main");
	public final ModelPart bipedLeftLeg;
	public final ModelPart bipedRightLeg;
	public final ModelPart bb_main;

	public Modelfrozen_leggings(ModelPart root) {
