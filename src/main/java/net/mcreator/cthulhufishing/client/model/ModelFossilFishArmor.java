...
public class ModelFossilFishArmor<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition bipedRightArm = bone.addOrReplaceChild("bipedRightArm",
		...
		PartDefinition cube_r1 = bipedRightArm.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(38, 51).addBox(0.8F, -9.2F, 17.6F, 4.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-4.0F, 22.0F, 0.0F, 1.212F, 0.1975F, 0.3091F));
		PartDefinition cube_r2 = bipedRightArm.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(62, 62).addBox(-2.0F, -24.15F, -5.75F, 4.25F, 12.25F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition bipedLeftArm = bone.addOrReplaceChild("bipedLeftArm",
				...
				PartPose.offset(-4.0F, -22.0F, 0.0F));
		PartDefinition cube_r3 = bipedLeftArm.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(72, 61).addBox(-2.25F, -23.15F, -5.75F, 4.25F, 11.25F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(4.0F, 22.0F, 0.0F, 0.0F, 1.5708F, 0.0F));
		PartDefinition cube_r4 = bipedLeftArm.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(39, 35).addBox(-9.0F, -22.4F, -11.3F, 4.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition bipedBody = bone.addOrReplaceChild("bipedBody", CubeListBuilder.create().texOffs(19, 51).addBox(-4.0F, 2.0F, -3.5F, 8.0F, 10.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(58, 0)
				.addBox(-5.0F, -1.0F, -5.5F, 10.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(0, 51).addBox(-4.0F, 0.1F, 2.5F, 8.0F, 12.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -24.0F, 0.0F));
		PartDefinition cube_r5 = bipedBody.addOrReplaceChild("cube_r5", CubeListBuilder.create().texOffs(62, 76).addBox(-3.0F, -24.0F, -4.65F, 6.25F, 13.0F, 1.25F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 24.0F, 0.0F, 0.0F, -1.5708F, 0.0F));
		PartDefinition cube_r6 = bipedBody.addOrReplaceChild("cube_r6", CubeListBuilder.create().texOffs(47, 76).addBox(-3.25F, -24.0F, -4.65F, 6.25F, 13.0F, 1.25F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 24.0F, 0.0F, 0.0F, 1.5708F, 0.0F));
		PartDefinition cube_r7 = bipedBody.addOrReplaceChild("cube_r7", CubeListBuilder.create().texOffs(31, 75).addBox(-1.0F, -25.5F, -11.15F, 2.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(31, 80)
		...
		PartDefinition cube_r8 = bipedBody.addOrReplaceChild("cube_r8", CubeListBuilder.create().texOffs(17, 34).addBox(2.4F, -20.0F, 2.2F, 5.0F, 5.0F, 5.0F, new CubeDeformation(0.0F)),
