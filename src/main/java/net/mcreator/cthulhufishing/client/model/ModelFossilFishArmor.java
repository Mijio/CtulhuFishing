...
public class ModelFossilFishArmor<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition bipedLeftArm = partdefinition.addOrReplaceChild("bipedLeftArm",
				CubeListBuilder.create().texOffs(47, 63).addBox(-4.0F, -1.0F, -2.5F, 5.0F, 10.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 75).addBox(-4.0F, -1.0F, 1.5F, 5.0F, 10.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(22, 75)
						.addBox(-4.0F, -1.0F, -1.5F, 1.0F, 10.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(0, 63).addBox(-4.0F, -3.0F, -2.5F, 5.0F, 2.0F, 5.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition armorLeftArm = bipedLeftArm.addOrReplaceChild("armorLeftArm", CubeListBuilder.create(), PartPose.offset(1.0F, 0.0F, 0.0F));
		PartDefinition bipedRightArm = partdefinition.addOrReplaceChild("bipedRightArm",
				CubeListBuilder.create().texOffs(57, 51).addBox(-1.0F, -3.0F, -2.5F, 5.0F, 2.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(34, 63).addBox(-1.0F, -1.0F, -2.5F, 5.0F, 10.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(21, 63)
						.addBox(-1.0F, -1.0F, 1.5F, 5.0F, 10.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(13, 75).addBox(3.0F, -1.0F, -1.5F, 1.0F, 10.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offset(4.5F, 2.0F, 0.0F));
		...
		PartDefinition armorRightArm = bipedRightArm.addOrReplaceChild("armorRightArm", CubeListBuilder.create(), PartPose.offset(-1.0F, 0.0F, 0.0F));
