 ...
 * @author Author
 */
public class BlockEyeAnimation {
	public static final AnimationDefinition Look around = AnimationDefinition.Builder.withLength(2.25F).looping()
		.addAnimation("eyelid", new AnimationChannel(AnimationChannel.Targets.POSITION, 
