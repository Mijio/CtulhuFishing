	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition RightLeg = partdefinition.addOrReplaceChild("RightLeg",
				CubeListBuilder.create().texOffs(0, 61)
						.addBox(0.9F, -0.8F, -2.25F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(17, 38)
						.addBox(-2.1F, -1.0F, 1.25F, 8.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 61)
						.addBox(0.9F, 0.4F, -2.25F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(17, 34)
						.addBox(-2.1F, 0.0F, 1.25F, 8.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 34)
						.addBox(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(34, 17)
						.addBox(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.25F)).texOffs(18, 56)
						.addBox(-2.1F, -1.0F, -2.25F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 56)
		...
		PartDefinition cube_r1 = RightLeg.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(14, 61)
						...
						.addBox(-2.0F, -12.0F, 3.25F, 4.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(22, 51)
		...
		PartDefinition LeftLeg = partdefinition.addOrReplaceChild("LeftLeg",
				CubeListBuilder.create().texOffs(17, 17)
						...
						.addBox(-0.9F, 0.0F, -2.25F, 3.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(9, 56)
						.addBox(-0.9F, -1.0F, -2.25F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(53, 56)
		...
		PartDefinition cube_r2 = LeftLeg.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(34, 61)
						...
						.addBox(1.0F, -3.0F, -4.25F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(33, 51)
						.addBox(-2.0F, -13.0F, -4.25F, 4.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(11, 51)
