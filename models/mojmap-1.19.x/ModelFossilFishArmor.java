...
public class ModelFossilFishArmor<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r1 = bipedRightArm.addOrReplaceChild("cube_r1",
		...
		PartDefinition cube_r2 = bipedRightArm.addOrReplaceChild("cube_r2",
		...
		PartDefinition cube_r3 = bipedLeftArm
		...
		PartDefinition cube_r4 = bipedLeftArm.addOrReplaceChild("cube_r4",
		...
		PartDefinition bipedBody = bone.addOrReplaceChild("bipedBody",
		...
		PartDefinition cube_r5 = bipedBody.addOrReplaceChild("cube_r5",
		...
		PartDefinition cube_r8 = bipedBody.addOrReplaceChild("cube_r8",
